...
def tokenize_with_indent(source: str) -> Iterator[Token]:
    """
    Tokenize with virtual brackets from indentation (tabs only).
    ...
    Use tab characters for block structure; spaces are not counted as indent.
    """
    lines = source.split("\n")
    current_indent = 0
